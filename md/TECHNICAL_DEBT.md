...
- [x] CI-режим 100 дней — `npm run simulate:ci`, `CI_THRESHOLDS`, тест в `stability.test.ts`
- [x] Гарантированный сезонный караван — `seasonStartDay` + принудительный визит
- [ ] Баланс 100-дневного обычного режима — 10 смертей на seed=2026 (порог 9); причина — голод, не амбар
- [x] Расширенная торговля (соль, железо, сезонные маршруты караванов)
