...
Обновлено: **2026-08-29** (ежедневный прогон Medieval Society Daily, v3.0.0).
...
| Smoke 14400 дней (20 лет) | **Следующий цикл** | Стресс после девятнадцати лет — 14400 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 14400 дней** — двадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 14400 дней; выбор размера карты.
