...
Обновлено: **2026-08-30** (ежедневный прогон Medieval Society Daily, v3.1.0).
...
| Smoke 15120 дней (21 год) | **Следующий цикл** | Стресс после двадцати лет — 15120 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 15120 дней** — двадцать один игровой год.
...
**Идеи для следующего цикла:** спрайты; smoke 15120 дней; выбор размера карты.
