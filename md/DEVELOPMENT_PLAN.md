...
Обновлено: **2026-08-28** (ежедневный прогон Medieval Society Daily, v2.9.0).
...
| Smoke 11520 дней (16 лет) | **Следующий цикл** | Стресс после восемнадцати лет — 13680 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 13680 дней** — девятнадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 13680 дней; выбор размера карты.
