...
Обновлено: **2026-08-15** (ежедневный прогон Medieval Society Daily, v2.3.0).
...
| Smoke 9360 дней (13 лет) | **Следующий цикл** | Стресс после двенадцати лет — 9360 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 9360 дней** — тринадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 9360 дней; выбор размера карты.
