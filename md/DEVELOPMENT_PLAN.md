...
Обновлено: **2026-08-19** (ежедневный прогон Medieval Society Daily, v2.6.0).
...
| Smoke 11520 дней (16 лет) | **Следующий цикл** | Стресс после пятнадцати лет — 11520 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 11520 дней** — шестнадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 11520 дней; выбор размера карты.
