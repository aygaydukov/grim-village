...
Обновлено: **2026-08-27** (ежедневный прогон Medieval Society Daily, v2.8.0).
...
| Smoke 11520 дней (16 лет) | **Следующий цикл** | Стресс после семнадцати лет — 12960 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 12960 дней** — восемнадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 12960 дней; выбор размера карты.
