...
Обновлено: **2026-08-14** (ежедневный прогон Medieval Society Daily, v2.2.0).
...
| Smoke 7920+ дней (11 лет) | **Следующий цикл** | Стресс после одиннадцати лет — 8640 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 8640 дней** — двенадцать игровых лет.
3. **Выбор размера карты** из UI.
4. **Диагностика миграционной нестабильности** — расширить инспектор (тренды по dayHistory).
...
**Идеи для следующего цикла:** спрайты; smoke 8640 дней; выбор размера карты.
