...
Обновлено: **2026-08-16** (ежедневный прогон Medieval Society Daily, v2.4.0).
...
| Smoke 7920 дней (11 лет) | **Сделано (v2.2.0)** | `EXA_LONG_THRESHOLDS`, ≥11 рождений, стабильно seed=2026. |
...
| Smoke 7920+ дней (11 лет) | **Сделано (v2.2.0)** | EXA_LONG_THRESHOLDS. |
| Smoke 10080 дней (14 лет) | **Следующий цикл** | Стресс после тринадцати лет — 10080 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 10080 дней** — четырнадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 10080 дней; выбор размера карты.
