...
Обновлено: **2026-08-17** (ежедневный прогон Medieval Society Daily, v2.5.0).
...
| Smoke 9360 дней (13 лет) | **Сделано (v2.4.0)** | `YOTTA_LONG_THRESHOLDS`, ≥13 рождений, стабильно seed=2026. |
| Диагностика миграционной нестабильности | **Сделано (v2.3.0)** | Тренд смертей/беженцев за 7 дн. в инспекторе «Деревня». |
| Smoke 8640 дней (12 лет) | **Сделано (v2.3.0)** | `ZETTA_LONG_THRESHOLDS`, ≥12 рождений, стабильно seed=2026. |
| Перезапуск при раннем вымирании (daemon) | **Сделано (v2.2.0)** | `maybeReset` — drop при alive=0 даже до 20-го дня. |
...
| Smoke 10800 дней (15 лет) | **Следующий цикл** | Стресс после четырнадцати лет — 10800 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 10800 дней** — пятнадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 10800 дней; выбор размера карты.
