...
|--------|---------|-------------|
| Постройка хижин батраками | **Сделано** | Приоритет №1; перенаселение >2.6 жит./хижину, амбар ≥52, кулдаун 3 дня. |
| Pathfinding A* | **Берём следующим** | Стройка расширяет карту — батраки чаще упираются в воду. |
| Государство / налог | **Отложить** | Нужна политика земли и очередь на жильё. |
...
1. **Pathfinding** — меньше застреваний у воды, особенно у стройплощадок.
2. **Государство / налог** — доля урожая «старосте», очередь на еду.
3. **Визуал стройки** — метка на карте до завершения хижины.
4. **Эпидемии** — редкий шок смертности (отдельно от неурожая).
5. **Выбор seed и размер карты из UI**.
