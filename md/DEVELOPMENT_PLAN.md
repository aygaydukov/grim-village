...
Обновлено: **2026-08-20** (ежедневный прогон Medieval Society Daily, v2.7.0).
...
| Smoke 11520 дней (16 лет) | **Следующий цикл** | Стресс после шестнадцати лет — 12240 дней. |
| Выбор размера карты из UI | **Отложить** | Seed уже есть (v1.6.0). |

## Следующие циклы (приоритет)

1. **Спрайты** — замена силуэтов.
2. **Smoke 12240 дней** — семнадцать игровых лет.
...
**Идеи для следующего цикла:** спрайты; smoke 12240 дней; выбор размера карты.
